...
try:
    from roboflex.core.flexbuffers import Builder, Loads
    from roboflex.core.flextensors import flex_decode, build_tensor
except Exception as e:
    from roboflex.core.python.flexbuffers import Builder, Loads
    from roboflex.core.python.flextensors import flex_decode, build_tensor
